...
const zhCnStrings = {
  ...
  launcher: {
    ...
    updateBanner: {
      ...
      downloading: '正在从 GitHub 下载版本 {version} · {percent}%',
      error: '无法安装更新。',
      install: '立即安装',
      installing: '正在重启',
      openSettings: '查看设置',
  ...
  settings: {
    ...
    about: {
      ...
      downloading: '正在从 GitHub 下载版本 {version} · {percent}%',
      error: '无法连接 GitHub 或检查更新失败。',
      idle: '打开主页后会自动连接 GitHub 检查更新。',
      install: '重启安装',
      installing: '正在重启',
      repository: 'GitHub 仓库',
      title: '关于与更新',
      unavailable: '自动更新仅适用于已安装版本。',
      upToDate: '已连接 GitHub，当前是最新版本',
      updateAvailable: '发现版本 {version}，正在从 GitHub 下载。',
...
const zhTwStrings: UiStrings = {
  ...
  launcher: {
    ...
    updateBanner: {
      checkFailed: '無法連接 GitHub 檢查更新',
      downloading: '正在從 GitHub 下載版本 {version} · {percent}%',
      error: '無法安裝更新。',
      install: '立即安裝',
      installing: '正在重新啟動',
      openSettings: '查看設定',
  ...
  settings: {
    ...
    about: {
      ariaLabel: '關於與更新',
      check: '檢查更新',
      checking: '正在連接 GitHub 檢查更新...',
      downloaded: '版本 {version} 已下載，重新啟動後安裝。',
      downloading: '正在從 GitHub 下載版本 {version} · {percent}%',
      error: '無法連接 GitHub 或檢查更新失敗。',
      idle: '開啟首頁後會自動連接 GitHub 檢查更新。',
      install: '重新啟動安裝',
      installing: '正在重新啟動',
      repository: 'GitHub 倉庫',
      title: '關於與更新',
      unavailable: '自動更新僅適用於已安裝版本。',
      upToDate: '已連接 GitHub，目前是最新版本',
      updateAvailable: '發現版本 {version}，正在從 GitHub 下載。',
      version: '{name} v{version}',
    },
    clipboardHistory: {
      ariaLabel: '剪貼簿歷史設定',
...
const enUsStrings: UiStrings = {
  ...
  launcher: {
    ...
    updateBanner: {
      checkFailed: 'Could not connect to GitHub for updates',
      downloading: 'Downloading version {version} from GitHub · {percent}%',
  ...
  screenshot: {
    actionFailed: 'Screenshot action failed.',
    controlsUnavailable: 'Screenshot controls are unavailable in this window.',
    groups: {
      color: 'Color',
      font: 'Font',
      format: 'Format',
    ...
    loadError: 'Unable to load screenshot capture.',
    loading: 'Loading screenshot...',
    ocr: {
      copyAll: 'Copy All',
      failed: 'OCR failed.',
      noText: 'No OCR text found.',
  ...
  settings: {
    ...
    about: {
      ...
      checking: 'Connecting to GitHub for updates...',
      downloaded: 'Version {version} is downloaded. Restart to install.',
      downloading: 'Downloading version {version} from GitHub · {percent}%',
      error: 'Could not connect to GitHub or check for updates.',
      idle: 'The launcher checks GitHub for updates after startup.',
      ...
      upToDate: 'Connected to GitHub. You are up to date',
      updateAvailable: 'Version {version} found. Downloading from GitHub.',
      version: '{name} v{version}',
    },
    clipboardHistory: {
