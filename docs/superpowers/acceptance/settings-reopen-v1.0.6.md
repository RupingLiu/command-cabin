...
- 发布后运行真实更新探针时，匿名 GitHub API 返回 HTTP 403；响应头确认额度 60、剩余 0，为当前出口的限流，未宣称本次探针通过。
- 已认证 GitHub API 确认 latest=1.0.6、非草稿、两个资产均 uploaded。
- 从公开 Releases URL 实际重新下载安装包及校验文件，6,464,014 字节，SHA512 与本地已验证构建完全一致。
