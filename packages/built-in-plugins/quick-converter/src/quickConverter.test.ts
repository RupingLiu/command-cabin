...
describe('quick converter built-in plugin', () => {
  ...
  it.each([
    ['1升', '1 升 = 1000 毫升 = 0.001 立方米 = 1000 立方厘米 = 61.0237 立方英寸'],
    ['1 L', '1 升 = 1000 毫升 = 0.001 立方米 = 1000 立方厘米 = 61.0237 立方英寸'],
    ['500毫升', '500 毫升 = 0.5 升 = 500 立方厘米 = 0.0005 立方米 = 30.5119 立方英寸'],
    ['2 m3', '2 立方米 = 2000 升 = 2000000 毫升 = 2000000 立方厘米 = 122047 立方英寸'],
    ['2m³', '2 立方米 = 2000 升 = 2000000 毫升 = 2000000 立方厘米 = 122047 立方英寸'],
    ['250cm3', '250 立方厘米 = 250 毫升 = 0.25 升 = 0.00025 立方米 = 15.2559 立方英寸'],
    ['250cc', '250 立方厘米 = 250 毫升 = 0.25 升 = 0.00025 立方米 = 15.2559 立方英寸'],
    ['1 in3', '1 立方英寸 = 16.3871 立方厘米 = 16.3871 毫升 = 0.0163871 升 = 0.0000163871 立方米'],
    ['1in³', '1 立方英寸 = 16.3871 立方厘米 = 16.3871 毫升 = 0.0163871 升 = 0.0000163871 立方米'],
    [
      '1立方英寸',
  ...
  it.each([
    ...
    ['1 in3', 'volume', 'cubicInch'],
    ['1 in³', 'volume', 'cubicInch'],
    ['1 inch3', 'volume', 'cubicInch'],
    ['1立方英寸', 'volume', 'cubicInch'],
    ['1 USD', 'currency', 'usd'],
    ['1美元', 'currency', 'usd'],
    ['1美金', 'currency', 'usd'],
